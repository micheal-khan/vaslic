        ...
        >
            ...
            <main className="pt-32 pb-24 px-8 max-w-7xl mx-auto relative z-10">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-48">
                    {products.map((p, i) => {
                        const CardWrapper = p.slug
                            ? ({ children }: { children: React.ReactNode }) => <Link href={p.slug!}>{children}</Link>
                                    ...
                                    <div className="mt-8 flex flex-col gap-4">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <div
                                                    className="text-[9px] uppercase tracking-tighter text-neutral-500"
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color: p.ctaVariant === "filled" ? "white" : BLOOD,
                                                background: p.ctaVariant === "filled" ? BLOOD : "transparent",
                                            }}
                                            onMouseEnter={(e) => {
                                            ...
                                            onMouseLeave={(e) => {
                                                const el = e.currentTarget;
                                                el.style.background = p.ctaVariant === "filled" ? BLOOD : "transparent";
                                                el.style.color = p.ctaVariant === "filled" ? "white" : BLOOD;
                                            }}
                                        >
                                            {p.cta}
                                        </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
                        {cemeteryItems.map((item, i) => (
                            <div
                                ...
                                style={{ marginTop: item.stagger ? `${item.stagger}px` : undefined }}
                            >
                                <div
                                    className="relative overflow-hidden bg-neutral-950 border p-4 transition-all duration-700"
                                    style={{
                                        aspectRatio: "3/5",
