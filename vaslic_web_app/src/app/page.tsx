...
// ─── Section data ─────────────────────────────────────────────────────────────
const gothicProducts = [
  { id: "VLK-GOTH-001", slug: "/gothic/vlk-goth-001", name: "OBSIDIAN VEIL", edition: "EDITION 1 OF 50", units: "04", img: heroSlices[0].image, delay: 0 },
  { id: "VLK-GOTH-002", name: "CATHEDRAL WRAP", edition: "EDITION 1 OF 25", units: "02", img: null, bg: "#2a0000", delay: 100 },
  { id: "VLK-GOTH-003", name: "NOCTURNE OVERCOAT", edition: "EDITION 1 OF 10", units: "01", img: null, bg: "#1a1a1a", delay: 200 },
  { id: "VLK-GOTH-004", name: "SHADOW MASK", edition: "EDITION 1 OF 100", units: "19", img: null, bg: "#410000", delay: 300 },
];

const bohemianProducts = [
  { id: "VLK-BOH-001", slug: "/bohemian/vlk-boho-001", name: "Linen Ghost", edition: "EDITION 1 OF 30", units: "07", img: heroSlices[1].image, delay: 0 },
  { id: "VLK-BOH-002", name: "Terracotta Tide", edition: "EDITION 1 OF 15", units: "03", img: null, delay: 100 },
  { id: "VLK-BOH-003", name: "Woven Nomad", edition: "EDITION 1 OF 50", units: "12", img: null, delay: 200 },
  { id: "VLK-BOH-004", name: "Amber Dusk", edition: "EDITION 1 OF 20", units: "01", img: null, delay: 300 },
];

const avantProducts = [
  { id: "VLK-AV-991", slug: "/avant-garde/vlk-avnt-001", name: "ASYMMETRY 01", edition: "EDITION 1 OF 05", units: "02", delay: 0 },
  { id: "VLK-AV-992", name: "VOID SLICER", edition: "EDITION 1 OF 08", units: "01", delay: 100 },
  { id: "VLK-AV-993", name: "MONO SCULPT", edition: "EDITION 1 OF 12", units: "04", delay: 200 },
  { id: "VLK-AV-994", name: "PRISM CLOAK", edition: "EDITION 1 OF 03", units: "LAST ONE", delay: 300 },
];

const streetProducts = [
  { id: "STR-VAULT-401", slug: "/street/vlk-strt-002", name: "BRUT-JACKET", edition: "EDITION 1 OF 100", units: "42", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuC7cfU3od2VnHPmlIE0Z4bNp7532rf8tCwWkhXwJMgn_ZXvUVQO-eczT6YlodxBxxuu3VuIdbv-gRcPpNS2jKfEs7lkxfqgxWzSqX7U_bYMaCQwGWuGYz2o94BMoMG5A7jjht1wNsmBs05wmcfs5aGoRaIRxjg9V1L0625oD9CFf_UO933AZu78AYe-AswlNj9RjrzFcAHrrIqZbWvKyz2Th4n9sVY9Qnj3xmAm3Rru_K8b9TuJGJ9VK3Q6UPIwtr5SEuQCJJ2nNJI", delay: 0 },
  { id: "STR-VAULT-402", name: "NEON DRIFT", edition: "EDITION 1 OF 50", units: "09", img: null, delay: 100 },
  { id: "STR-VAULT-403", name: "GRAFF CARGO", edition: "EDITION 1 OF 75", units: "15", img: null, delay: 200 },
  { id: "STR-VAULT-404", name: "CITY SLICKER", edition: "EDITION 1 OF 25", units: "03", img: null, delay: 300 },
];

const funkyProducts = [
  { id: "FNK-CUR-501", slug: "/funky/vlk-fnky-001", name: "GLITCH DREAM", edition: "EDITION 1 OF 40", units: "12 LEFT", delay: 0 },
  { id: "FNK-CUR-502", name: "SYNTH WAVE", edition: "EDITION 1 OF 20", units: "02 LEFT", delay: 100 },
  { id: "FNK-CUR-503", name: "DISCO VOID", edition: "EDITION 1 OF 50", units: "38 LEFT", delay: 200 },
  { id: "FNK-CUR-504", name: "PIXEL FLOW", edition: "EDITION 1 OF 15", units: "04 LEFT", delay: 300 },
];

const retiredDesigns = [
  { year: "2023 EDITION", name: "OBSIDIAN DRIFT", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBFRXQVhx_ad-IRj9c3dn9lNC381i8eulYpTDNKkYWJioxiadYrEBi9YeXG0laBu1B9s85m-hbLpB1YLrnvc5A9FUL94l5MWs3jDfNTELpeuoXgLuMuR-98Q5LOiwxFtOB5jcQmhUYYcNA1FLUzuYOngQhOlP7ZWCYqgvCuLjgDxBGjXh_ip2Z9A34VCczI_XfT-1FQVzm7doMeke0LPrSRKI8IuqMSH3qhAxAykRQc7Re4t6kaL-0hYtJGeRv6-WN5x3U-sJB_f5g" },
  { year: "2022 EDITION", name: "DUST ROSE", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCpSE_fH0mbUQ1LY0sIbMTCJUiLU43fiAupKZRkyiV-wyliG1eqUhKRGz0Y0TowHTBsxjy_qNWUJB5is-Ba_6dwZ9KHAP_oT7yEju0TyKRqGCrsnZF8MnTg6TFxD7ghR97qmsmfmAIyvkUOEW1-WDGvyLcqNEh1WaOdur3XQZ_Xpds3ZLNNdiJl3xH-NFpjyhcIeBY9ihfSJNFwV9JVtM5Ybci03POtfEyvi7akj2jglcgXx6wiHhTYLkUtRq6wMW4NODLwDrcD2rk" },
  { year: "2021 EDITION", name: "MONO BLUR", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDKXSvbwG_KveYjk-FENj3c3hMw0a5IfKx2jETxUhGSeGdX6iAcCx6rsd4t0UBkI9_G2qZzwJER1HImsHlKiVO5O-QFv_iKDEinmCazIf1x5lZBeoqGzkUcMnfZkayCC7-ZL_WntGcruFaMJb5nUm4eQnm3DFHKiM9RhlVPgMaf8LpBsfNZyLIyHhS0USDCd54gsUa9Mxp1lnE-RGPk7N9pR1xwnwqgAHIrgIpM81zhiZSoxB2o3EeaZCaCIbfpPWu_qBfmvmhQA7E" },
  { year: "2020 EDITION", name: "CYBER REVERIE", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBv1DHE3LJVbE9MG7YxXWZuPtftvhYAW9tipwLWWWJo7NU8B9Vd44I9MhuX70NcI18PgAD6C9CmJbXN-k7vgy4Lhd8IcjZSucXSVbovwc1Jl2fMxOjgEzZCzzPsOoicvCwlAdMVACW7QIb9EYCXOmE7LP5J3G3IzgOOVp2ppOU3apE5mTWG8XDN41AE3rxek-xepNYyBGZLTBE6kRHV8jsju0T1NaexTWuTk7pb1eewPtzLd5vzvQuxkVn_wwQ_Iv2vw0aHh1PMgzs" },
];
    ...
    <div className="bg-black text-white overflow-x-hidden" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <section id="gothic" className="min-h-screen bg-black py-32 px-12 flex flex-col justify-center" style={{ backgroundImage: `url(https://lh3.googleusercontent.com/aida-public/AB6AXuAz0xm-W0iEQ7vWqXrHGwo3DfB5ugIKExvhSg-VdP7pzCulo8MGmzl0H6xUhQLSyfyPY9SIYKr0E-3c9kL714vo6lL9GaEEq6mJznqFNO8CYmjBotQSfyEiYDNkvBHr9__4H7uD5lOV8zzPovI4Iofe8hoCeErk7MY7peTJZFQ-cVo-i1HLEkXbvKdILAn6ReHVy_9hErkJSJm-V5YmmFvkuWISUGKXvHHDONkLQ2RBcgZpmVfUAZB_Uv1cDQ4_-31Ty55G6fwB3TM)`, backgroundBlendMode: "overlay", backgroundSize: "cover" }}>
        <div className="max-w-[1400px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {gothicProducts.map((p) => (
              <RevealSection key={p.id}>
                <ProductCard
                  {...p} img={p.img ?? null} bg={p.bg ?? "#171717"} slug={p.slug}
                  idColor="#920703"
      ...
      <section id="bohemian" className="min-h-screen py-32 px-12 flex flex-col justify-center text-black" style={{ background: "#f5ebe0" }}>
        <div className="max-w-[1400px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {bohemianProducts.map((p) => (
              <RevealSection key={p.id}>
                <ProductCard
                  {...p} img={p.img ?? null} bg="white" slug={p.slug}
                  idColor="#8b5e3c"
        ...
        <div className="max-w-[1400px] mx-auto w-full relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {avantProducts.map((p) => (
              <RevealSection key={p.id}>
                <ProductCard
                  {...p} img={null} bg="white" slug={p.slug}
                  idColor="black"
        ...
        <div className="max-w-[1400px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {streetProducts.map((p) => (
              <RevealSection key={p.id}>
                <ProductCard
                  {...p} img={p.img ?? null} bg="#262626" slug={p.slug}
                  idColor="#d8ca23"
        ...
        <div className="max-w-[1400px] mx-auto w-full relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {funkyProducts.map((p) => (
              <RevealSection key={p.id}>
                <ProductCard
                  {...p} img={null} bg="#1a1a4a" slug={p.slug}
                  idColor="#ffb4a8"
